...
resource "terraform_data" "api_gateway_custom" {
  ...
  provisioner "local-exec" {
    ...
    command = "aws apigateway create-rest-api --name ${self.input} --region ${data.aws_region.current.name} --endpoint-url http://localhost:4566 --binary-media-types 'multipart/form-data'"
  }
}
...
resource "aws_api_gateway_integration" "campaigns_public_get" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Campaign/public"
}
...
resource "aws_api_gateway_integration" "campaigns_post" {
  ...
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Campaign"
}
...
resource "aws_api_gateway_integration" "campaign_id_get" {
  ...
  integration_http_method = "GET"
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Campaign/{id}"
...
resource "aws_api_gateway_integration" "campaigns_images_post" {
  ...
  integration_http_method = "POST"
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Campaign/images"
...
resource "aws_api_gateway_integration" "campaign_id_cancel_post" {
  ...
  integration_http_method = "POST"
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Campaign/{id}/cancel"
...
resource "aws_api_gateway_integration" "users_doador_public_post" {
  ...
  integration_http_method = "POST"
  type                    = "HTTP_PROXY"
  uri                     = "http://users-api:${var.container_port}/api/v1/User/Doador"
...
resource "aws_api_gateway_integration" "users_images_public_post" {
  ...
  integration_http_method = "POST"
  type                    = "HTTP_PROXY"
  uri                     = "http://users-api:${var.container_port}/api/v1/User/images"
...
resource "aws_api_gateway_integration" "users_refresh_token_public_post" {
  ...
  integration_http_method = "POST"
  type                    = "HTTP_PROXY"
  uri                     = "http://users-api:${var.container_port}/api/v1/User/RefreshToken"
  content_handling        = "CONVERT_TO_TEXT"
}
...
resource "aws_api_gateway_integration" "users_session_get" {
  ...
  integration_http_method = "GET"
  type                    = "HTTP_PROXY"
  uri                     = "http://users-api:${var.container_port}/api/v1/User/Session/{sessionId}"
...
resource "aws_api_gateway_integration" "users_make_gestor_ong_put" {
  ...
  integration_http_method = "PUT"
  type                    = "HTTP_PROXY"
  uri                     = "http://users-api:${var.container_port}/api/v1/User/MakeGestorONG"
}
...
resource "aws_api_gateway_integration" "donations_post" {
  ...
  integration_http_method = "POST"
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Donation"
}
...
resource "aws_api_gateway_integration" "donation_me_get" {
  ...
  integration_http_method = "GET"
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Donation/me"
}
...
resource "aws_api_gateway_integration" "donation_id_get" {
  ...
  integration_http_method = "GET"
  type                    = "HTTP_PROXY"
  uri                     = "http://campaigns-api:${var.container_port}/api/v1/Donation/{id}"
